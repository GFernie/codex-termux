...
Validated for: **v0.91.1-termux** (built from upstream `rust-v0.91.0`).
...
**Patches Applied**: 8 (revalidated for v0.91.1-termux)
**Based on**: OpenAI Codex rust-v0.91.0
**Platform**: Android Termux ARM64
**Upstream Changes**: 0.88.0 → 0.91.0 (v0.91.1-termux is a republish with packaging fixes)
...
## v0.91.1-termux Updates

**Note**: v0.91.1-termux is a republish of v0.91.0-termux with packaging fixes
(corrected binary versions in the npm package). No upstream code changes were
introduced beyond the version bump.
...
- ✅ Patch #3: Version alignment - Verified (0.91.1-termux)
...
**CODEX_TEST_REPORT_v0.91.0.md Summary:**
- Total Tests: 50
- ✅ Passed: 50
- ❌ Failed: 0
- ⚠️ Skipped: 1
- Binary sizes: codex 65MB, codex-exec 40MB, codex-tui 48MB
- **VERDICT: ALL PASS**
