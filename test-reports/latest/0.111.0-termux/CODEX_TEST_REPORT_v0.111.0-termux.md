...
Codex Version: codex-cli 0.111.0 / codex-exec 0.111.0
Test Date: 2026-03-08 (CET)
Suite Source: test-reports/suites/latest/termux.md
Primary Raw Log: TERMUX_SAFE_RAW_20260308-022318.log
...
5. v0.111.0 Dependency Crash Guard: 2/2 passed
...
NOTES:
------
- Global package verified: @mmmbuto/codex-cli-termux@0.111.0-termux.
...
- Dependency crash guards validated:
  - source feature trees contain no `voice-input`, `cpal`, `oboe`, or `oboe-sys` markers for Android target
  - ELF linkage shows no `libc++_static`, `libOpenSLES.so`, or `liboboe.so`

DETAILED RESULTS:
-----------------
- Install Guard / npm package: PASS
  - @mmmbuto/codex-cli-termux@0.111.0-termux found globally.
...
- Version Guard: PASS
  ...
  - codex-exec --version => codex-exec 0.111.0
...
- Dependency guard / feature chain: PASS
  - cargo tree output for Android target is clean of forbidden voice/audio markers.

- Dependency guard / linkage: PASS
  - readelf shows shared runtime only; no static libc++, OpenSLES, or oboe linkage.
